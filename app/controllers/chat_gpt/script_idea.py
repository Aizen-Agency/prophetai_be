...
def generate_script_ideas(product_name, description, script_idea, twitter_content=None):
    try:
        ...
        prompt = f"""Generate 10 unique and engaging script ideas for a product called '{product_name}'.
        
Product Description: {description}

User's Script Idea Requirements: {script_idea}

{f"Twitter Content Context: {twitter_content}" if twitter_content else ""}

Generate 10 different script ideas that:
